...
RSpec.describe "Api::Messages", type: :request do
  ...
  describe "GET /messages" do
    it "get messages with another user" do
      user.friends << friend
      user.messages.create!(receiver_id: friend.id, receiver_type: 'User', content: 'message okay')
      user.messages.create!(receiver_id: friend.id, receiver_type: 'User', content: 'message okay')
    ...
    it "get messages inside a group" do
      user.groups << group
      user.save!
      user.messages.create!(group_id: group.id, receiver_type: 'Group', content: 'message for group')
      user.messages.create!(group_id: group.id, receiver_type: 'Group', content: 'message for group')
      user.messages.create!(group_id: group.id, receiver_type: 'Group', content: 'message for group')
