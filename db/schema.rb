...
ActiveRecord::Schema[8.0].define(version: 2025_06_19_212709) do
  ...
  create_table "message_read_statuses", force: :cascade do |t|
    ...
    t.index ["message_id"], name: "index_message_read_statuses_on_message_id"
  ...
  add_foreign_key "groups", "conversations"
  add_foreign_key "message_read_statuses", "messages"
